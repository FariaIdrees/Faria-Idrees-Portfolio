  ...
  return (
    <button
      ...
      className={cn(
        ...
        "bg-surface/60 text-fg-muted backdrop-blur-sm transition-colors duration-200",
    ...
    >
      <span className="relative block h-4.5 w-4.5" aria-hidden="true">
        <Sun
          className="absolute inset-0 h-4.5 w-4.5 rotate-0 scale-100 opacity-100 transition-all duration-200 ease-out-expo dark:-rotate-90 dark:scale-50 dark:opacity-0"
          strokeWidth={1.75}
        />
        <Moon
          className="absolute inset-0 h-4.5 w-4.5 rotate-90 scale-50 opacity-0 transition-all duration-200 ease-out-expo dark:rotate-0 dark:scale-100 dark:opacity-100"
          strokeWidth={1.75}
        />
      </span>
    </button>
